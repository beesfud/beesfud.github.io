...
/***/ function(module, exports, __webpack_require__) {
	...
	var Buzz = __webpack_require__(157);

	var BuzzList = React.createClass({
	  displayName: 'BuzzList',
	  ...
	  render: function render() {
	    var items = this.state.items.map(function (item) {
	      return React.createElement(
	        'div',
	        { id: 'item' },
	        React.createElement(Voter, { votes: item.votes, uuid: item['.key'], text: item.text }),
	        React.createElement(
	          'div',
	          { id: 'text' },
	          item.text
...
/***/ function(module, exports) {
	...
	var choice = function choice(arr) {
	...
	var punc = function punc(num) {
	  return choice(['.', '!', '']);
	};

	var reasons = function reasons(num) {
	...
	var mostAbout = function mostAbout(num) {
